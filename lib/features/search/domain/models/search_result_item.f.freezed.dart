...
part of 'search_result_item.f.dart';
...
abstract class $SearchResultItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({String key, String body});
}
...
class _$SearchResultItemImpl implements _SearchResultItem {
  const _$SearchResultItemImpl({required this.key, required this.body});
  ...
  @override
  String toString() {
    return 'SearchResultItem(key: $key, body: $body)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, key, body);
...
abstract class _SearchResultItem implements SearchResultItem {
  const factory _SearchResultItem(
      ...
      required final String body}) = _$SearchResultItemImpl;
